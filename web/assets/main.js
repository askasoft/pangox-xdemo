var main = {
	...
	init: function() {
		// header theme switch
		$('#header .themedrop a').on('click', function(e) {
			e.preventDefault();
			...
			$('#header .themedrop a').removeClass('active');
			$a.addClass('active');

			$('#header .themedrop button').find('i').attr('class', $a.find('i').attr('class'));
